...
enum ForteTable {
    static func name(forPrimeForm primeForm: [Int]) -> String? {
        guard (2...12).contains(primeForm.count) else { return nil }
        let key = primeForm.map(String.init).joined(separator: ",")
        return namesByPrimeForm[key]
    }

    static let namesByPrimeForm: [String: String] = [
        "0,1": "2-1",
        "0,2": "2-2",
        "0,3": "2-3",
        "0,4": "2-4",
        ...
        "0,1,3,5,7,8": "6-Z26",
        "0,1,3,5,7,9": "6-34",
        "0,1,3,5,8,9": "6-31", // Forte
        "0,1,3,6,7,9": "6-30",
        "0,1,3,6,8,9": "6-Z29", // Forte
        "0,1,4,5,6,8": "6-16",
        "0,1,4,5,7,9": "6-31", // Rahn
        "0,1,4,5,8,9": "6-20",
        "0,1,4,6,7,9": "6-Z50",
        "0,2,3,4,5,7": "6-8",
        "0,2,3,4,5,8": "6-Z39",
        ...
        "0,1,2,4,6,8,9": "7-30",
        "0,1,2,4,6,8,10": "7-33",
        "0,1,2,4,7,8,9": "7-20", // Forte
        "0,1,2,5,6,7,9": "7-20", // Rahn
        "0,1,2,5,6,8,9": "7-22",
        "0,1,3,4,5,6,8": "7-11",
        "0,1,3,4,5,7,8": "7-Z37",
        "0,1,3,4,5,7,9": "7-26",
